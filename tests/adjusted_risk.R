...
ex <- paste("We expect at least 2 unit risk groups \\(URG\\). ie",
            "the length of the vector arguments should be > 1")
...
ex <- paste("The length of the proportions vector must",
            "be equal to the length of the RR vector")
stopifnot(length(grep(ex, ob)) == 1)
